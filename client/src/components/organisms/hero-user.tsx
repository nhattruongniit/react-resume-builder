      ...
      <div className="pb-20 font-poppins">
          ...
          <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
            <a href="https://prebuiltui.com">
              <img src="assets/images/logo.svg" alt="PrebuiltUI Logo" className="h-11 w-auto" />
            </a>
          ...
          <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
              ...
              <div className="flex items-center gap-4 ">
                <Link to={PATH.APP} className="bg-green-500 hover:bg-green-600 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-green-400 flex items-center transition-colors">
                  Get started
